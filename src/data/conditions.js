export const defaultConditions = [
    ...
    { code: '局部上', name: 'クラスプ義歯（上顎）', symbol: '局上', color: 'bg-blue-100 border-blue-400 text-blue-800' },
    { code: '局部下', name: 'クラスプ義歯（下顎）', symbol: '局下', color: 'bg-indigo-100 border-indigo-400 text-indigo-800' },
    { code: '総義歯上', name: '総義歯（上顎）', symbol: '総上', color: 'bg-teal-100 border-teal-400 text-teal-800' },
    { code: '総義歯下', name: '総義歯（下顎）', symbol: '総下', color: 'bg-cyan-100 border-cyan-400 text-cyan-800' }
];
